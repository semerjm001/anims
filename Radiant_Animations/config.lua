...
Config.Anims = {
    ...
    {name = 'backslap', data = {type = 'anim', ad = "anim@mp_player_intcelebrationpaired@f_f_backslap", anim = "backslap_right_facial", prop = 0, proptwo = 0, boneone = nil, bonetwo = nil, body = 49, x = 0.0, y = 0.0, z = 0.0, xa = 0.0, yb = 0.0, zc = 0.0}},
    {name = 'backslap1', data = {type = 'anim', ad = "anim@mp_player_intcelebrationpaired@f_m_backslap", anim = "backslap_right_facial", prop = 0, proptwo = 0, boneone = nil, bonetwo = nil, body = 49, x = 0.0, y = 0.0, z = 0.0, xa = 0.0, yb = 0.0, zc = 0.0}},
    {name = 'backslap2', data = {type = 'anim', ad = "anim@mp_player_intcelebrationpaired@m_m_backslap", anim = "backslap_right_facial", prop = 0, proptwo = 0, boneone = nil, bonetwo = nil, body = 49, x = 0.0, y = 0.0, z = 0.0, xa = 0.0, yb = 0.0, zc = 0.0}},
    {name = 'hug', data = {type = 'anim', ad = "anim@mp_player_intcelebrationpaired@f_f_bro_hug", anim = "bro_hug_left", prop = 0, proptwo = 0, boneone = nil, bonetwo = nil, body = 49, x = 0.0, y = 0.0, z = 0.0, xa = 0.0, yb = 0.0, zc = 0.0}},
